 ...
 *
 * Used by the add-food skill to confirm every base/special ingredient a new
 * food wants already exists in the shared catalog -- add-food never creates
 * a new ingredient itself (see that skill's Hard rules).
 *
