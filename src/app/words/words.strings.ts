  ...
  en: {
    ...
    shop: {
      ...
      modal: {
        ...
        ingredientCost: "Cost",
        ingredientCostUnit: "coins",
        ingredientDetailsTitle: "Ingredient Details",
        ingredientTapHint: "Tap an ingredient card to see a bigger picture and cost.",
        ingredientNoCost: "Cost not set yet.",
    ...
    shopAdmin: {
      ...
      ingredients: {
        ...
        moveDown: "Move Down",
        helper:
          "Choose a catalog ingredient to auto-fill names, units, and icon art, or leave it custom for text-only rows.",
      },
      ingredientPricing: {
        title: "Ingredient Prices",
        heading: "Edit Shared Unit Prices",
        helper:
          "Set the per-unit price for each ingredient here once. Recipe rows only control how much of that ingredient the recipe needs.",
        unitEnglish: "Unit (EN)",
        unitChinese: "Unit (ZH)",
        noUnit: "No unit",
        cost: "Price Per Unit (coins)",
        save: "Save Prices",
        saving: "Saving...",
        reset: "Reset Prices",
  ...
  zh: {
    ...
    shop: {
      ...
      modal: {
        ...
        ingredientCost: "价格",
        ingredientCostUnit: "金币",
        ingredientDetailsTitle: "材料详情",
        ingredientTapHint: "点击材料卡片可查看更大的图片和价格。",
        ingredientNoCost: "还没有设置价格。",
        specialSlots: "特殊材料",
    ...
    shopAdmin: {
      ...
      ingredients: {
        ...
        moveUp: "上移",
        moveDown: "下移",
        helper: "选择目录材料会自动填入名称、单位和图标；留空则保持为纯文字自定义材料。",
      },
      ingredientPricing: {
        title: "材料价格",
        heading: "统一编辑单价",
        helper: "每种材料的单价只在这里设置一次。食谱里的材料行只负责说明这个食物需要多少该材料。",
        unitEnglish: "英文单位",
        unitChinese: "中文单位",
        noUnit: "无单位",
        cost: "单价（金）",
