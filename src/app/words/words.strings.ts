  ...
  en: {
    ...
    fillTest: {
      ...
      results: {
        ...
        sentenceResultLabel: "Sentence {number}: {sentence}",
        chosenLabel: "chosen: {phrase}",
        expectedLabel: "expected: {phrase}",
  ...
  zh: {
    ...
    fillTest: {
      ...
      results: {
        ...
        sentenceResultLabel: "例句 {number}: {sentence}",
        chosenLabel: "选择: {phrase}",
        expectedLabel: "期望: {phrase}",
        finishButton: "完成测试",
      },
      summary: {
        title: "上次填空总结",
