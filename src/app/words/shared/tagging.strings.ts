...
export const taggingStrings = {
  en: {
    ...
    allEditor: {
      ...
      updateTagsSuccess: "Updated tags for {count} words.",
      updateTagsError: "Failed to update tags. Please try again.",
      ...
      tooltips: {
        ...
        updateTags: "Replace existing lesson tags on selected words with the selected tag.",
  ...
  zh: {
    ...
    allEditor: {
      ...
      updateTagsSuccess: "已更新 {count} 个汉字的标签。",
      updateTagsError: "更新标签失败，请重试。",
      clearTags: "清除标签",
      clearingTags: "清除中...",
      ...
      tooltips: {
        ...
        updateTags: "先清除所选汉字的现有标签，再添加当前选择的标签。",
