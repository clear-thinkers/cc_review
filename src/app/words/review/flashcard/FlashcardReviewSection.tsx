    ...
    <section className="space-y-3 rounded-lg border p-4">
      ...
      {!flashcardInProgress ? (
        <div className="space-y-3 rounded-md border border-dashed p-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link
              href="/words/review"
              className="rounded-md border-2 px-4 py-2 text-sm font-medium btn-confirm"
            >
            ...
            <>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    type="button"
                    className="rounded-md border-2 px-3 py-2 btn-secondary"
      ...
      {flashcardInProgress ? (
        <div className="flex justify-center flex-wrap gap-2">
          <button
            type="button"
            className="rounded-md border-2 px-3 py-2 text-sm font-medium btn-confirm disabled:opacity-50"
          ...
          {activeReviewTestSession ? (
            <button
              type="button"
              className="rounded-md border-2 px-3 py-2 text-sm font-medium btn-caution disabled:opacity-50"
